...
import { requestPasswordReset } from "@/app/actions/authSupport";
...
export default function RecoveryPage() {
  ...
  const handleRecovery = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success) {
        setMessage(res.message || "Solicitação enviada!");
        setEmail("");
      } else {
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 mt-2">
            Digite seu e-mail cadastrado para enviarmos as instruções.
          </p>
        </div>
        ...
        <div className="glass p-8 rounded-[2.5rem] space-y-6">
          <form onSubmit={handleRecovery} className="space-y-4">
            <div className="space-y-2">
              <label className="text-xs font-bold text-zinc-400 ml-1 uppercase tracking-wider">E-mail</label>
