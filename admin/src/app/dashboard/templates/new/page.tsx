...
import { createTemplate } from "@/app/actions/content";
...
export default function NewTemplatePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <header>
        <h1 className="text-3xl font-bold tracking-tight">Novo <span className="text-primary">Template</span></h1>
        <p className="text-zinc-500 mt-1">Disponibilize arquivos, designs ou códigos para os membros do Vault.</p>
      </header>
        ...
        <div className="flex flex-col md:flex-row gap-4 pt-4">
          ...
          >
            {loading ? <Loader2 className="w-6 h-6 animate-spin" /> : 
             success ? <><CheckCircle2 className="w-6 h-6" /> TEMPLATE SALVO!</> :
             <><Save className="w-6 h-6" /> PUBLICAR TEMPLATE</>}
          </button>
